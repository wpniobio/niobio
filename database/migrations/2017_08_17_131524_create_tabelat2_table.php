...
class CreateTabelat2Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tabelat2', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('emit_ie')->default('0.00');
            ...
            // CNPJ DE DESTINATÀRIO
            $table->string('dest_cnpj')->default('0.00');
            $table->string('dest_ie')->default('0.00');
            //
